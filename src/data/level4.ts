...
const level4Questions: Omit<Question, "difficulty">[] = [
  // Topic: Binary
  {
  ...
  {
    question: "What decimal number does the binary number 11011 represent?",
    answer: "27",
    topic: "Binary",
  ...
  // Topic: Hexadecimal
  {
    question: "Convert the hexadecimal number 2A to decimal.",
    answer: "42",
    topic: "Hexadecimal",
  },
  {
    question: "What is the hexadecimal equivalent of decimal 63?",
    answer: "3F",
    topic: "Hexadecimal",
  },
  {
    question: "Convert the decimal number 100 to hexadecimal.",
    answer: "64",
    topic: "Hexadecimal",
  },
  ...
  // Topic: Octal
  {
    question: "Convert the decimal number 64 to octal.",
    answer: "100",
    topic: "Octal",
  },
  {
    question: "What is the octal equivalent of decimal 40?",
    answer: "50",
    topic: "Octal",
  },
  {
    question: "Convert the octal number 77 to decimal.",
    answer: "63",
    topic: "Octal",
  },
  ...
  {
    question: "Which of the following is a natural number: -5, 0, 5.5, 10?",
    answer: "10",
    topic: "Natural Numbers",
  },
  ...
  {
    question: "Calculate the absolute value of -20.",
    answer: "20",
    topic: "Integers",
  },
  ...
  {
    question: "List all prime numbers between 10 and 20.",
    answer: "11,13,17,19",
    topic: "Factors and Primes",
  },
  {
  ...
  {
    question: "Find all factors of 18.",
    answer: "1,2,3,6,9,18",
    topic: "Factors and Primes",
  },
  ...
  {
    question: "Express 84 as a product of prime numbers.",
    answer: "2^2 * 3 * 7",
    topic: "Fundamental Theorem of Arithmetic",
  },
  {
    question: "What is the unique prime factorization of 100?",
    answer: "2^2 * 5^2",
    topic: "Fundamental Theorem of Arithmetic",
  },
  {
    question: "Express 70 as a product of primes.",
    answer: "2 * 5 * 7",
    topic: "Fundamental Theorem of Arithmetic",
  },
  ...
  {
    question: "Find the prime factors of 105.",
    answer: "3 * 5 * 7",
    topic: "Prime Factorization",
  },
  {
    question: "What are the prime factors of 17?",
    answer: "17",
    topic: "Prime Factorization",
  },
  {
    question: "Express 90 as a product of prime numbers.",
    answer: "2 * 3^2 * 5",
    topic: "Prime Factorization",
  },
  ...
  {
    question: "What is the GCD of 27 and 36?",
    answer: "9",
    topic: "GCD and LCM",
  },
  ...
  {
    question: "Is 0.121221222... an irrational number?",
    answer: "Yes",
    topic: "Rational and Irrational Numbers",
  },
  {
    question: "Is the square root of 9 a rational number?",
    answer: "Yes",
    topic: "Rational and Irrational Numbers",
  },
  {
    question: "Is the number π (pi) rational or irrational?",
    answer: "Irrational",
    topic: "Rational and Irrational Numbers",
  },
  ...
  {
    question: "Is 0.333... (repeating) a real number?",
    answer: "Yes",
    topic: "Real Numbers",
  },
  ...
  {
    question: "Evaluate log base 10 of 0.1.",
    answer: "-1",
    topic: "Logarithms",
  },
  ...
  {
    question: "If f(x) = x^2 - 4x, find f(5).",
    answer: "5",
    topic: "Functions",
    format: "Enter the numerical result only",
  },
  ...
  {
    question:
      "For f(x) = 1/(x^2 - 1), what values are excluded from the domain?",
    answer: "x = 1, x = -1",
    topic: "Domain, Codomain, Range",
    format: "List values separated by comma and space. Example: x = 1, x = -1",
  },

  // Topic: Inverse Functions
  {
    question: "What is the inverse of f(x) = (x - 2)/3?",
    answer: "f^(-1)(x) = 3x + 2",
    topic: "Inverse Functions",
    format: "Use f^(-1)(x) = for inverse function notation",
  },
  {
    question: "Find the inverse of f(x) = x^3, x ≥ 0.",
    answer: "f^(-1)(x) = x^(1/3)",
    topic: "Inverse Functions",
    format: "Use f^(-1)(x) = and ^ for exponents",
  },
  {
    question: "What is the inverse function of f(x) = 1/(x - 1)?",
    answer: "f^(-1)(x) = 1/x + 1",
    topic: "Inverse Functions",
    format: "Use f^(-1)(x) = and standard arithmetic notation",
  },
  ...
  {
    question: "If f(x) = 2x and g(x) = x^2, find (g ∘ f)(3).",
    answer: "36",
    topic: "Composite Functions",
    format: "Enter the numerical result only",
  },
  {
    question: "Given f(x) = x - 3 and g(x) = x^2, compute (f ∘ g)(4).",
    answer: "13",
    topic: "Composite Functions",
    format: "Enter the numerical result only",
  },
